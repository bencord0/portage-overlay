...
HOMEPAGE="https://github.com/CrunchyData/postgresql-prometheus-adapter/"
SRC_URI="https://github.com/CrunchyData/postgresql-prometheus-adapter/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
