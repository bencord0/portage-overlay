...
# upstream_jdomain (https://github.com/nicholaschiasson/ngx_upstream_jdomain, BSD-2)
HTTP_UPSTREAM_JDOMAIN_PV="1.1.5"
HTTP_UPSTREAM_JDOMAIN_P="ngx_upstream_jdomain-${HTTP_UPSTREAM_JDOMAIN_PV}"
HTTP_UPSTREAM_JDOMAIN_URI="https://github.com/nicholaschiasson/ngx_upstream_jdomain/archive/${HTTP_UPSTREAM_JDOMAIN_PV}.tar.gz"
HTTP_UPSTREAM_JDOMAIN_WD="${WORKDIR}/${HTTP_UPSTREAM_JDOMAIN_P}"
...
SRC_URI="https://nginx.org/download/${P}.tar.gz
	...
	nginx_modules_http_upstream_jdomain? ( ${HTTP_UPSTREAM_JDOMAIN_URI} -> ${HTTP_UPSTREAM_JDOMAIN_P}.tar.gz )
...
src_configure() {
	...
	if use nginx_modules_http_upstream_jdomain; then
		http_enabled=1
		myconf+=( --add-module=${HTTP_UPSTREAM_JDOMAIN_WD} )
	fi
